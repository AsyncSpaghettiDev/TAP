...
namespace TallerCarroceria {
    public partial class Especialidades : UserControl {
        ...
        private void crearGrid( ) {
            this.bunifuDataGridView1.ColumnCount = 2;
        ...
        private void cargarGrid( ) {
            // Comando de consulta
            SqlCommand consulta = new SqlCommand("SELECT * FROM Especialidades", this.conexion);
            // Se abre la conexion
            this.conexion.Open();
            ...
            while (data.Read()) {
                ...
                string[] row = new string[] { data[ 0 ].ToString(), data[ 1 ].ToString() };
        ...
        private void cargarComboBox( ) {
            ...
            SqlCommand obtenerID = new SqlCommand("SELECT idEspecialidad FROM Especialidades", this.conexion);
            // Se abre la conexión
            this.conexion.Open();
            ...
            while (IDs.Read()) {
                ...
                this.comboBox1.Items.Add(IDs[ "idEspecialidad" ].ToString());
            }
            // Se cierra la conexion
            this.conexion.Close();
        ...
        public void alta( object sender, EventArgs e ) {
            ...
            SqlCommand altas = new SqlCommand("INSERT INTO Especialidades VALUES(@ID,@Nombre)", this.conexion);
        ...
        public void baja( object sender, EventArgs e ) {
            ...
            SqlCommand bajas = new SqlCommand("DELETE FROM Especialidades WHERE idEspecialidad = @ID", this.conexion);
        ...
        private void actualizar( object sender, EventArgs e ) {
            ...
            SqlCommand actualizar = new SqlCommand("UPDATE Especialidades SET idEspecialidad=@ID,nombreEspecialidad=@Nombre WHERE idEspecialidad=@ID", this.conexion);
            // Se pasan los valores de los textBox a las variables temporales
        ...
        public void buscar( object sender, EventArgs e ) {
            ...
            SqlCommand consulta = new SqlCommand("SELECT * FROM Especialidades WHERE idEspecialidad=@ID", this.conexion);
