...
namespace Universidad {
    public partial class UserControl1 : UserControl {
        ...
        private void cargarComboBox( ) {
            ...
            SqlCommand obtenerID = new SqlCommand("SELECT idProf FROM profesores", this.conexion);
            // Se abre la conexión
            this.conexion.Open();
            ...
            while (IDs.Read()) {
                ...
                this.comboBox1.Items.Add(IDs[ "idProf" ].ToString());
            }
        ...
        public void alta( ) {
            ...
            altas.Parameters.AddWithValue("idProf", int.Parse(this.comboBox1.Text));
            ...
            altas.Parameters.AddWithValue("telefonoProf", long.Parse(this.bunifuTextBox4.Text));
            ...
            altas.Parameters.AddWithValue("centroProf", int.Parse(this.bunifuTextBox8.Text));
            // Se abre la conexion
            this.conexion.Open();
            // Se cargan los datos a la BD
        ...
        public void baja( ) {
            ...
            SqlCommand bajas = new SqlCommand("DELETE FROM profesores WHERE idProf = @idProf", this.conexion);
            bajas.Parameters.AddWithValue("idProf", int.Parse(this.comboBox1.Text));
        ...
        public void actualizar( ) {
            ...
            SqlCommand actualizar = new SqlCommand("UPDATE profesores SET nombreProf=@nombreProf,direccionProf=@direccionProf,telefonoProf=@telefonoProf,emailProf=@emailProf,departamentoProf=@departamentoProf,dedicacionProf=@dedicacionProf,centroProf=@centroProf WHERE idProf = @idProf", this.conexion);
            // Se cargan las variables que se declaraon en el comando anterior
            actualizar.Parameters.AddWithValue("idProf", int.Parse(this.comboBox1.Text));
            actualizar.Parameters.AddWithValue("nombreProf", this.bunifuTextBox2.Text);
            actualizar.Parameters.AddWithValue("direccionProf", this.bunifuTextBox3.Text);
            actualizar.Parameters.AddWithValue("telefonoProf", long.Parse(this.bunifuTextBox4.Text));
            actualizar.Parameters.AddWithValue("emailProf", this.bunifuTextBox5.Text);
            actualizar.Parameters.AddWithValue("departamentoProf", this.bunifuTextBox6.Text);
            actualizar.Parameters.AddWithValue("dedicacionProf", this.bunifuTextBox7.Text);
            actualizar.Parameters.AddWithValue("centroProf", int.Parse(this.bunifuTextBox8.Text));
            // Se abre la conexion
            this.conexion.Open();
        ...
        private void crearGrid( ) {
            ...
            this.bunifuDataGridView1.Columns[ 5 ].Name = "Departamento";
            this.bunifuDataGridView1.Columns[ 6 ].Name = "Dedicación";
            this.bunifuDataGridView1.Columns[ 7 ].Name = "Centro Educativo";
        ...
        private void cargarGrid( ) {
            // Comando de consulta
            SqlCommand consulta = new SqlCommand("SELECT * FROM profesores", this.conexion);
            // Se abre la conexion
            this.conexion.Open();
        ...
        public void buscar( ) {
            ...
            SqlCommand consulta = new SqlCommand("SELECT * FROM profesores WHERE idProf=@idProf", this.conexion);
            // Se carga el id en el parametro usado en el comando SQL
            consulta.Parameters.AddWithValue("idProf", int.Parse(this.comboBox1.Text));
            // Se abre la conexion
            this.conexion.Open();
            ...
            while (data.Read()) {
                ...
                this.bunifuTextBox8.Text = data[ 7 ].ToString();
