...
namespace Universidad {
    public partial class UserControl2 : UserControl {
        ...
        private void cargarComboBox( ) {
            ...
            SqlCommand obtenerID = new SqlCommand("SELECT expedienteAlumno FROM alumnos", this.conexion);
            // Se abre la conexión
            this.conexion.Open();
            ...
            while (IDs.Read()) {
                ...
                this.comboBox1.Items.Add(IDs[ "expedienteAlumno" ].ToString());
            }
            ...
            // Se cargan los ID's (campo clave) de la tabla en cuestion
            obtenerID = new SqlCommand("SELECT idProf FROM profesores", this.conexion);
            // Se "guardan" todos los ID's en SqlDataReader, que no es mas que una lista de arrays
            IDs = obtenerID.ExecuteReader();
            // Mientras haya datos en el SqlDataReader se leeran los datos
            while (IDs.Read()) {
                // Se añade ID por ID al comboBox
                this.comboBox2.Items.Add(IDs[ "idProf" ].ToString());
            }
            // Se cierra la conexion
            this.conexion.Close();
        ...
        public void alta( ) {
            ...
            altas.Parameters.AddWithValue("expedienteAlumno", int.Parse(this.comboBox1.Text));
            ...
            altas.Parameters.AddWithValue("telefonoAlumno", long.Parse(this.bunifuTextBox4.Text));
            ...
            altas.Parameters.AddWithValue("idProf", int.Parse(this.comboBox2.Text));
            // Se abre la conexion
            this.conexion.Open();
            // Se cargan los datos a la BD
        ...
        public void baja( ) {
            ...
            SqlCommand bajas = new SqlCommand("DELETE FROM alumnos WHERE expedienteAlumno = @expedienteAlumno", this.conexion);
            bajas.Parameters.AddWithValue("expedienteAlumno", int.Parse(this.comboBox1.Text));
        ...
        public void actualizar( ) {
            ...
            SqlCommand actualizar = new SqlCommand("UPDATE alumnos SET nombreAlumno=@nombreAlumno,direccionAlumno=@direccionAlumno,telefonoAlumno=@telefonoAlumno,emailAlumno=@emailAlumno,centroAlumno=@centroAlumno,titulacionAlumno=@titulacionAlumno,idProf=@idProf WHERE expedienteAlumno = @expedienteAlumno", this.conexion);
            // Se cargan las variables que se declaraon en el comando anterior
            actualizar.Parameters.AddWithValue("expedienteAlumno", int.Parse(this.comboBox1.Text));
            actualizar.Parameters.AddWithValue("nombreAlumno", this.bunifuTextBox2.Text);
            actualizar.Parameters.AddWithValue("direccionAlumno", this.bunifuTextBox3.Text);
            actualizar.Parameters.AddWithValue("telefonoAlumno", long.Parse(this.bunifuTextBox4.Text));
            actualizar.Parameters.AddWithValue("emailAlumno", this.bunifuTextBox5.Text);
            actualizar.Parameters.AddWithValue("centroAlumno", this.bunifuTextBox6.Text);
            actualizar.Parameters.AddWithValue("titulacionAlumno", this.bunifuTextBox7.Text);
            actualizar.Parameters.AddWithValue("idProf", int.Parse(this.comboBox2.Text));
            // Se abre la conexion
            this.conexion.Open();
        ...
        // Se crean las columnas del dataGrid y se les da nombre a cada columna, el campo ID se restringe a 100px
        private void crearGrid( ) {
            this.bunifuDataGridView1.ColumnCount = 8;
            this.bunifuDataGridView1.Columns[ 0 ].Name = "Expediente";
            this.bunifuDataGridView1.Columns[ 0 ].Width = 100;
            ...
            this.bunifuDataGridView1.Columns[ 5 ].Name = "Centro";
            this.bunifuDataGridView1.Columns[ 6 ].Name = "Titulación";
            this.bunifuDataGridView1.Columns[ 7 ].Name = "ID Profe";
        ...
        private void cargarGrid( ) {
            // Comando de consulta
            SqlCommand consulta = new SqlCommand("SELECT * FROM alumnos", this.conexion);
            // Se abre la conexion
            this.conexion.Open();
            ...
            while (data.Read()) {
                ...
                string[] row = new string[] { data[ 0 ].ToString(), data[ 1 ].ToString(), data[ 2 ].ToString(), data[ 3 ].ToString(), data[ 4 ].ToString(), data[ 5 ].ToString(), data[ 6 ].ToString(), data[ 7 ].ToString() };
        ...
        public void buscar( ) {
            ...
            SqlCommand consulta = new SqlCommand("SELECT * FROM alumnos WHERE expedienteAlumno=@expedienteAlumno", this.conexion);
            // Se carga el id en el parametro usado en el comando SQL
            consulta.Parameters.AddWithValue("expedienteAlumno", int.Parse(this.comboBox1.Text));
            // Se abre la conexion
            this.conexion.Open();
            ...
            while (data.Read()) {
                ...
                this.comboBox2.SelectedIndex = this.comboBox2.Items.IndexOf(data[ 7 ].ToString());
        ...
        public bool validate( bool validar = true ) {
            ...
            if (string.IsNullOrEmpty(this.comboBox2.Text)) {
                MessageBox.Show("¡Ingrese un ID de profesor!");
                return false;
            }
